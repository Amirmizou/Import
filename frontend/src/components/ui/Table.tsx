...
export const TableFooter: React.FC<TableFooterProps> = ({ children, className }) => (
  <tfoot className={cn('border-t bg-gray-50/50 font-medium [&>tr]:last:border-b-0 dark:bg-gray-800/50', className)}>
    {children}
  </tfoot>
)
...
// Composant TableContainer pour wrapper le tableau
